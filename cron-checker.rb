...
reg = [
	/^(\*(\/[1-9][0-9]*)?|[1-5]?[0-9](-[1-5]?[0-9](\/[1-9][0-9]*)?)?)$/,
	/^(\*(\/[1-9][0-9]*)?|(1?[0-9]|2[0-3])(-(1?[0-9]|2[0-3])(\/[1-9][0-9]*)?)?)$/,
	/^(\*(\/[1-9][0-9]*)?|([1-9]|[12][0-9]|3[01])(-([1-9]|[12][0-9]|3[01])(\/[1-9][0-9]*)?)?)$/,
	/^(\*(\/[1-9][0-9]*)?|([1-9]|1[0-2])(-([1-9]|1[0-2])(\/[1-9][0-9]*)?)?)$/,
	/^(\*(\/[1-9][0-9]*)?|[0-7](-[0-7](\/[1-9][0-9]*)?)?)$/,
]

default = [60, 24, 32, 13, 8]

(0..4).each do |i|
	ARGV[i].split(',').each do |cond|
